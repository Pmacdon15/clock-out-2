      ...
      <div className="prose prose-zinc dark:prose-invert max-w-none">
        <section className="mb-12">
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-400">
            By accessing or using Clock Out, you agree to be bound by these
        ...
        <section className="mb-12">
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-400">
            Clock Out is provided as a time-tracking tool for organizations and
            individuals. You are responsible for maintaining the security of
        ...
        <section className="mb-12">
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-400">
            We strive for precision in time tracking. However, users are
            responsible for verifying their own logged hours and ensuring
            organization reports are accurate.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-400">
            ...
            time. We will provide notice of significant changes to these terms.
          </p>
        </section>
