...
import { Calendar, Check, Loader2, Settings, XCircle } from "lucide-react";
...
const options = [
  {
    id: "off",
    label: "Off",
    description: "No reports will be sent",
    icon: XCircle,
  },
  {
    id: "weekly",
...
export default function ReportingSettings({
    ...
    return (
      <Card className="p-8 text-center">
        ...
        <p className="mx-auto max-w-sm text-muted-foreground">
          Custom report frequencies are only available on paid plans. Upgrade
          your organization to unlock this feature.
        </p>
  ...
  return (
    <Card className="p-8">
      <div className="mb-8">
        <h3 className="font-bold text-2xl tracking-tight">Report Frequency</h3>
        <p className="text-muted-foreground">
          Choose how often your team's hours reports are sent to admins.
        </p>
      </div>
          ...
          <div className="space-y-4" key={option.id}>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {initialData?.report_frequency === option.id && (
            ...
            {frequency === "custom" && option.id === "custom" && (
              <div className="fade-in slide-in-from-top-2 grid animate-in grid-cols-1 gap-4 p-6 pt-0 md:grid-cols-2">
                <div className="space-y-2">
                  <label className="font-medium text-sm" htmlFor="reportDay">
                    Reporting Day
                  </label>
                  <select
      ...
      <div className="mt-8 flex justify-end">
        <Button
          ...
          onClick={() => {
            ...
            const interval = frequency === "custom" ? reportInterval : 1;
